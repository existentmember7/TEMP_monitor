...
def save_class_activation_images(org_img, activation_map, folder, file_name):
    """
    ...
    """
    if not os.path.exists('../saliency_maps/{0}'.format(folder)):
        os.makedirs('../saliency_maps/{0}'.format(folder))
    # Grayscale activation map
    heatmap, heatmap_on_image = apply_colormap_on_image(
        org_img, activation_map, 'jet')
    # Save colored heatmap
    # path_to_file = os.path.join('../saliency_maps/{0}'.format(folder),
